...
function createNewOrder($table_id, $cust_id, $conn) {
    ...
    $insert_order_sql = "INSERT INTO orders (cust_id, table_id, order_date) VALUES ('$cust_id', '$table_id', '$currentDate')";
...
<body>
    ...
    <section class="home-section"> 
        <div class="header">
            <a href="table.php" class="header-logo">Order Management</a>
        </div>
            ...
            <table border="1">
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<input type='number' name='quantity' id='quantity{$row["menu_id"]}' value='1' min='1'>";
        ...
        <div class="right-column">
            <table border="1">
                ...
                foreach ($cartItems as $cartItem) {
                    ...
                    echo "<button type='submit'><i class='bx bx-trash' ></i></button>";
                    echo "</form>";
                    echo "</td>";
                    echo "</tr>";
