       ...
       <table border="1">
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>";
                    echo "<form method='POST' action='status.php?menu_id=" . $row["menu_id"] . "'>";

                    if ($row["menu_status"] == "Available") {
                        echo "<button type='submit' name='menu_status' value='Discontinued'>Available</button>";
                    } else {
                        echo "<button type='submit' name='menu_status' value='Available'>Discontinued</button>";
                    }
                    echo "</form>";
                    echo "</td>";
