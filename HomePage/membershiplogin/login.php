...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($email_err) && empty($password_err)){
        ...
        $sql = "SELECT cust_id, cust_email, cust_password FROM customer WHERE cust_email = ?";
        ...
        if($stmt = mysqli_prepare($conn, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                mysqli_stmt_bind_result($stmt, $id, $email, $plain_password); // Change $hashed_password to $plain_password
...
<body>
    <div class="wrapper">
        <h2>Login</h2>
        <p>Please fill in your information to join our pages.</p>
