...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($name_err) && empty($contact_err) && empty($reservation_date_err) && empty($reservation_time_err) && empty($num_guests_err) && empty($table_err)) {
        ...
        $sql = "INSERT INTO reservations (name, contact, reservation_date, reservation_time, num_guests, table_number) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    <div class="container">
        ...
        <div class="form-container">
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" onsubmit="return validateForm()">
                ...
                <div class="form-group">
                    <label for="table">Table Number (1 to 7)</label>
                    <select id="table" name="table" class="form-control <?php echo (!empty($table_err)) ? 'is-invalid' : ''; ?>" required>
                        ...
                        for ($i = 1; $i <= 10; $i++) {
                            ...
                            1 => 4,
                            2 => 4,
                            3 => 4, // Set the capacity for Table 3 to 5
                            4 => 4,
                            5 => 6,
                            6 => 6,
                            7 => 6,
                            ...
                            $selected = ($table == $i) ? 'selected' : '';
            
                            // Display the option in the desired format
                            echo "<option value='$i' $selected>Table $i ({$table_capacities[$i]} capacity)</option>";
                            }
                        ?>
                    </select>
        ...
        <section class="page-section" id="contact2">
            <div class="container">
                ...
                <form id="contactForm" data-sb-form-api-token="API_TOKEN">
                    ...
                    <!-- Submit Button-->
                    <div class="text-center"><button class="btn btn-primary btn-xl text-uppercase disabled" id="submitButton" type="submit" onclick="myFunction()">Send Message</button></div>
                </form>
            </div>
        </section>
        <!-- Footer-->
